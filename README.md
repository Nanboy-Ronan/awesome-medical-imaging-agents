...
> **Coverage gaps to fill:** Mammography agents, ophthalmic agents for OCT-specific tasks, fMRI/DTI agents, and capsule endoscopy are sparsely represented — opportunities for future contributions.
...
- [Pathology Agents (Whole-Slide Imaging · Digital Pathology) (18)](#pathology-agents-whole-slide-imaging--digital-pathology-18)
- [Ultrasound Agents (Echocardiography · Robotic Ultrasound) (11)](#ultrasound-agents-echocardiography--robotic-ultrasound-11)
...
- [3D CT / MRI / Volumetric Imaging Agents (12)](#3d-ct--mri--volumetric-imaging-agents-12)
...
- [Benchmarks and Evaluation](#benchmarks-and-evaluation)
  ...
  - [Safety, Robustness, and Fairness (20)](#safety-robustness-and-fairness-20)
...
- [Agentic Automation of BT-RADS Scoring: End-to-End Multi-Agent System for Standardized Brain Tumor Follow-up Assessment](https://arxiv.org/abs/2603.21494) — arXiv (2026). Multi-agent system combining an extractor agent (clinical notes) and a scorer agent (BT-RADS decision logic + volumetric CNN segmentation) for standardized post-treatment glioma MRI response assessment.
- [Agentic LLM Workflow for MR Spectroscopy Volume-of-Interest Placements in Brain Tumors](https://arxiv.org/abs/2603.13371) — arXiv (2026). LLM agent decomposes spectroscopy VOI placement into candidate generation and optimal selection via tool calls, enabling user-instruction-driven MRS acquisition planning.

---

## Pathology Agents (Whole-Slide Imaging · Digital Pathology) (18)

Agents for whole-slide image (WSI) analysis, histopathology, digital pathology, and pathology report generation.

- [PathNavigate: A Training-Free Pathology Agent with Surprise-Guided Scan and Shared Slide Memory for Whole-Slide Image VQA](https://arxiv.org/abs/2605.23559) — arXiv (2026). Training-free WSI agent performs surprise-guided low-magnification scanning and shared-memory filtering to identify question-relevant regions before high-resolution evidence extraction for VQA.
...
## Ultrasound Agents (Echocardiography · Robotic Ultrasound) (11)

Agents for echocardiography interpretation, robotic ultrasound acquisition, and ultrasound-guided procedures.

- [Towards Reliable Fetal Ultrasound Interpretation with Multi-Agent Collaboration](https://arxiv.org/abs/2605.25357) — arXiv (2026). FetUSAgents coordinates specialized visual tools and LLM agents with Dual-Path Evidence Arbitration for fetal ultrasound interpretation, outperforming baselines by over 25% on the accompanying FetUS-VQA benchmark covering 10 clinical tasks.
...
- [EchoAgent: Guideline-Centric Reasoning Agent for Echocardiography Measurement and Interpretation](https://arxiv.org/abs/2511.13948) — arXiv (2025). Orchestrates specialized echocardiography vision tools under LLM control for guideline-centric temporal localization, spatial measurement, and clinical interpretation of cardiac studies.
...
## Ophthalmology Agents (6)

Agents for ophthalmic image analysis, myopia screening, diabetic retinopathy detection, glaucoma diagnosis, and pre-consultation education in eye care settings.
...
- [MedChat: A Multi-Agent Framework for Multimodal Diagnosis with Large Language Models](https://arxiv.org/abs/2506.07400) — IEEE MIPR (2025). Director agent coordinates role-specific LLM agents (ophthalmologist, glaucoma specialist, optometrist, pharmacist) each receiving deep-learning classifier outputs for fundus-based glaucoma diagnosis.
- [Detection and Diagnosis of Diabetic Retinopathy in Retinal Fundus Images Using Agentic AI Approaches](https://www.nature.com/articles/s41598-025-34016-0) — Scientific Reports (2025). AADR-AI uses JADE/Mesa autonomous agents that specialize in preprocessing, feature extraction, fusion, classification, and clinical explanation for diabetic retinopathy detection from retinal fundus images.

---

## 3D CT / MRI / Volumetric Imaging Agents (12)

Agents for volumetric CT, MRI, PET/CT, and neuroimaging analysis including segmentation, dosimetry, and multi-organ reasoning.

- [BCER Agent: Reliable Long-Horizon MRI Workflow Execution via Compilation, Artifact Binding, and Bounded Local Recovery](https://arxiv.org/abs/2605.29163) — arXiv (2026). Controller architecture that decouples planning from execution for long-horizon MRI analysis pipelines, with bounded local recovery to prevent cascading failures across multi-organ brain, prostate, and cardiac tasks.
- [NeuroAgent: LLM Agents for Multimodal Neuroimaging Analysis and Research](https://arxiv.org/abs/2605.06584) — arXiv (2026). Hierarchical multi-agent system that automates preprocessing, validation, and analysis of heterogeneous neuroimaging data (sMRI, fMRI, dMRI, PET) through a Generate-Execute-Validate engine with feedback-driven error recovery.
- [3DMedAgent: Unified Perception-to-Understanding for 3D Medical Analysis](https://arxiv.org/abs/2602.18064) — arXiv (2026). Enables 2D MLLMs to perform general 3D CT analysis by coordinating visual and textual tools with a structured long-term memory for multi-step perception-to-understanding reasoning across 40+ tasks.
...
- [MARL-Rad: Multi-Modal Multi-Agent Reinforcement Learning for Radiology Report Generation](https://arxiv.org/abs/2603.16876) — arXiv (2026). Jointly trains region-specific observation agents and a global integrating agent via clinically verifiable rewards, achieving state-of-the-art RadGraph and CheXbert scores on MIMIC-CXR.
...
## Medical Vision-Language Model (VLM) Agents (17)
...
- [A Medical Multimodal Diagnostic Framework Integrating Vision-Language Models and Logic Tree Reasoning](https://arxiv.org/abs/2512.21583) — arXiv (2025). Combines VLM alignment with a reasoning controller that decomposes diagnostic tasks into stepwise premises and a logic tree generator that assembles verifiable conclusions for interpretable multi-step diagnosis.
...
> **Navigate by theme** — this section contains 50 entries. Quick-jump to relevant clusters:
> - **Multi-agent debate and deliberation:** MDAgents, MedAgents, DxChain, CoMMa, Within the MDT Room, MedCollab, MediHive, ConfAgents
> - **Longitudinal EHR and oncology:** TrajOnco, HARMON-E, ClinNoteAgents, Agentic clinical reasoning (myeloma), HypAgent, EndoGov
> - **Retrieval-augmented clinical reasoning:** QuarkMedSearch, PubMed Reasoner, MedCoRAG, Agentic memory-augmented retrieval, Agentic Medical Knowledge Graphs, CDR-Agent
> - **Treatment and risk planning:** TheraAgent, TxAgent, AgentMD *(see Agent Skills)*
> - **Specialty-specific:** WiseMind (psychiatry), DeepRare (rare disease), Mapis (PCOS), Agentic Cognitive Profiling (Alzheimer's), SymptomAI (triage)

- [ClinSeekAgent: Automating Multimodal Evidence Seeking for Agentic Clinical Reasoning](https://arxiv.org/abs/2605.20176) — arXiv (2026). Automated evidence-seeking agent that queries medical knowledge bases, EHRs, and medical imaging tools to assemble multimodal clinical evidence, with significant gains on chest X-ray and EHR-based reasoning benchmarks.
...
- [TheraAgent: Self-Improving Therapeutic Agent for Precise and Comprehensive Treatment Planning](https://arxiv.org/abs/2605.05963) — ACL 2026. Iterative generate-judge-refine treatment-planning agent with a treatment-specific evaluator for safer and more complete therapeutic recommendations.
...
- [MedAgentSim: Self-Evolving Multi-Agent Simulations for Realistic Clinical Interactions](https://arxiv.org/abs/2503.22678) — MICCAI 2025. Open-source simulated clinical environment where self-evolving doctor agents engage in multi-turn conversations with patient and measurement agents, requesting examinations and imaging results (MRI, X-ray) to mimic real-world diagnostic workflows. [Code](https://github.com/MAXNORM8650/MedAgentSim)
...
- [A co-evolving agentic AI system for medical imaging analysis](https://arxiv.org/abs/2509.20279) — arXiv (2025). TissueLab integrates standardized tool factories across pathology, radiology, and spatial omics domains and enables real-time expert feedback for iterative, explainable multi-domain imaging analysis.
- [Simple Agents Outperform Experts in Biomedical Imaging Workflow Optimization](https://arxiv.org/abs/2512.06006) — arXiv (2025). Simple LLM agent framework automatically generates adaptation code for production biomedical imaging pipelines using small gold-standard validation sets, consistently outperforming human-expert manual adaptation.
- [Autonomous Computer Vision Development with Agentic AI](https://arxiv.org/abs/2506.11140) — arXiv (2025). LLM-based agent autonomously configures, trains, and tests medical image analysis pipelines by extending SimpleMind with automated planning and tool-calling, achieving strong chest X-ray segmentation performance.
...
- [MedRCube: A Multidimensional Framework for Fine-Grained and In-Depth Evaluation of MLLMs in Medical Imaging](https://arxiv.org/abs/2604.13756) — arXiv (2026). Evaluates 33 MLLMs across anatomical region, imaging modality, and task-type dimensions with 7,626 samples from 36 datasets, exposing capability gaps invisible to coarse single-metric evaluations.
...
### Safety, Robustness, and Fairness (20)
...
- [Trustworthy Medical Imaging with Large Language Models: A Study of Hallucinations Across Modalities](https://arxiv.org/abs/2508.07031) — arXiv (2025). Studies hallucination patterns in both image-to-text interpretation and text-to-image generation across X-ray, CT, and MRI, cataloguing factual inconsistencies and anatomical inaccuracies with implications for clinical deployment.
...
*Generated from README.md + `data/papers.yml` — last refreshed 2026-05-30. Run `python scripts/update_themes.py` to refresh.*
...
### Hallucination and Reliability (19)
...
- [NeuroAgent: LLM Agents for Multimodal Neuroimaging Analysis and Research](https://arxiv.org/abs/2605.06584) — 2026 · *3D Imaging Agents*
